...
export const Component = ({
    ...
    return (
        <div className={styl.root}>
            ...
            <HashLink id="actions-as-dependencies-parameter-for-react-effects" className={styl.contentSubTitle}><code>actions</code> as dependency parameter for <code>React Effects</code></HashLink>
            ...
            <NoteBlock content='"Non-static functions cannot be a part of the useEffect dependency list. This would result in infinite loop re-rendering the component over and over agin. A function is a new function reference (pointer in memory) each time the component renders. By this useEffect gets triggers the re-render because of the dependency. Checkout the react documentation for using "useEffect". For non-static functions you could rather use "React.useCallback" hook to memoize the function called within useEffect. For more info on useCallback refer:' type="info">
                <ul>
            ...
            <HashLink id="actions-with-async-dependencies" className={styl.contentTitle}>Actions with <code>Async Dependency</code></HashLink>
