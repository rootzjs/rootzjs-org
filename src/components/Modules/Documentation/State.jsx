...
export const Component = ({
    ...
    return (
        <div className={styl.root}>
            ...
            />
            <Typography variant="body1" gutterBottom><code>getAllNodes</code> returns the entire <SelfLink name="Root" route="/thinking-rootz" mask="Thinking Rootz" /> variable. This variable consists of entries of Nodes along with its properties. </Typography>
            <div className={styl.contentSubTitle}>Container Object</div>
            ...
            />
            <div className={styl.contentTitle}>Updating State</div>
            ...
            <div className={styl.contentSubTitle}>Always use <code>Actions</code> to update state</div>
            <Typography variant="body1" gutterBottom>You can think of actions as a smart messanger which computes the logical body defined and requests the state container to update the state of the Node. That makes it mandatory to update the state through actions only.</Typography>
            <CodeBlock 
                lang="javascript"
                isLight={isLight}
            ...
            />
            <div className={styl.contentSubTitle}>Single vs Nested state update</div>
            ...
            <Typography variant="body1" gutterBottom>In case of updating single layered state objects you can use <code>useAction</code> property of <SelfLink name="Node" route="/node" /> without a callback functionality.</Typography>
            <div className={styl.codeHeadLabel}>Updating single layered state properties</div>
            <CodeBlock 
                lang="javascript"
                isLight={isLight}
            ...
            <div className={styl.codeHeadLabel}>Updating nested state properties</div>
            <CodeBlock 
                lang="javascript"
                isLight={isLight}
